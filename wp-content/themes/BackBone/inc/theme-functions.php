...
function load_stylesheets()
{
  ...
  wp_register_style('backbone_stylesheet', get_template_directory_uri() . '/style.css', array(), $version, 'all');
  wp_enqueue_style('backbone_stylesheet');
}
...
function advance_numeric_pagination( $custom_query ) {
  ...
  if ($total_pages > 1){
    ...
    echo paginate_links(array(
      'prev_text' => __( '<svg version="1.2" baseProfile="tiny" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 459 306" xml:space="preserve"><g><g id="keyboard-backspace"><polygon points="459,127.5 96.9,127.5 188.7,35.7 153,0 0,153 153,306 188.7,270.3 96.9,178.5 459,178.5 "/></g></g></svg>' ),
      'next_text' => __( '<svg version="1.2" baseProfile="tiny" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 459 306" xml:space="preserve"><g><g id="keyboard-backspace"><polygon points="0,178.5 362.1,178.5 270.3,270.3 306,306 459,153 306,0 270.3,35.7 362.1,127.5 0,127.5 "/></g></g></svg>' ),
